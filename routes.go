...
func (s *server) routes() {
	...
	s.router.Handle("/chat/whatsapp-history", c.Then(s.GetWhatsAppHistory())).Methods("GET")
	s.router.Handle("/chat/whatsapp-history-sync", c.Then(s.SyncWhatsAppHistory())).Methods("POST")
